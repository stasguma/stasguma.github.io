...
///////////
    var data = [
        {
            spanImg: "news__pic",
            imgSrc: "img/news-pic1.jpg",
            title: "Advanced Machinery Helps Improve Quality",
            users: "cmsmasters",
            comments: 6,
            describe: "Cum sociis natoque penatibus et magnis dis parturient ontesmus. Pro vel nibh et elit mollis commodo et nec augueique Nemo enim ipsam voluptatem quia ptas sit aspernatur samomo enim ipsam voluptatem."
        },
        {
            spanImg: "news__pic2",
            imgSrc: "img/news-pic2.jpg",
            title: "Powerful Techniques for Advanced Service",
            users: "2cmsmasters",
            comments: 3,
            describe: "2 Cum sociis natoque penatibus et magnis dis parturient ontesmus. Pro vel nibh et elit mollis commodo et nec augueique Nemo enim ipsam voluptatem quia ptas sit aspernatur samomo enim ipsam voluptatem."
        }
    ];
    ...
    $('.complementary > .content').prepend(tmpl);
...
var parseArray = JSON.parse(JSON.stringify(data));
...
var skills = _.map(parseArray, 'skills');
skills = _.flattenDeep(skills);
skills = _.sortBy(skills);
skills = _.sortedUniq(skills);
...
var names = _.map(_.orderBy(parseArray, 'friends', 'desc'), 'name');
console.log("names = ", names);

// 3. Массив всех друзей всех пользователей, не должно быть повторяющихся людей.

var friends = _.sortBy(_.uniq(_.map(_.flattenDeep(_.map(parseArray, 'friends') ), 'name')) );
